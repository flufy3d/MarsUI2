...
class FCefCookieManager
	: public IBrowserCoreCookieManager
{
public:
...
private:
	...
	friend FCefBrowserCoreCookieManagerFactory;
};

TSharedRef<IBrowserCoreCookieManager> FCefBrowserCoreCookieManagerFactory::Create(
	const CefRefPtr<CefCookieManager>& CookieManager)
{
