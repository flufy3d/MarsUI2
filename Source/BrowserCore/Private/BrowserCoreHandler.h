...
class FBrowserCorePopupFeatures;
...
public:
	...
	/** Default constructor. */
	FBrowserCoreHandler(bool InUseTransparency);
...
public:
	 ...
	 */
	void SetBrowserWindow(TSharedPtr<FBrowserCoreWindow> InBrowserWindow);
	 ...
	 */
	void SetPopupFeatures(const TSharedPtr<FBrowserCorePopupFeatures>& InPopupFeatures)
	{
...
public:
	...
	IBrowserCoreWindow::FOnBeforePopupDelegate& OnBeforePopup()
	{
		return BeforePopupDelegate;
	}

	IBrowserCoreWindow::FOnCreateWindow& OnCreateWindow()
	{
...
private:
	...
	IBrowserCoreWindow::FOnBeforePopupDelegate BeforePopupDelegate;
	
	/** Delegate for handling requests to create new windows. */
	IBrowserCoreWindow::FOnCreateWindow CreateWindowDelegate;

	/** Weak Pointer to our Web Browser window so that events can be passed on while it's valid.*/
	TWeakPtr<FBrowserCoreWindow> BrowserWindowPtr;
	
	/** Pointer to the parent web browser handler */
	CefRefPtr<FBrowserCoreHandler> ParentHandler;

	/** Stores popup window features and settings */
	TSharedPtr<FBrowserCorePopupFeatures> BrowserPopupFeatures;

	// Include the default reference counting implementation.
	IMPLEMENT_REFCOUNTING(FBrowserCoreHandler);
};
