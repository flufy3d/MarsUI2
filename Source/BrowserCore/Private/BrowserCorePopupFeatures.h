...
#include "IBrowserCorePopupFeatures.h"
...
class FBrowserCorePopupFeatures
	: public IBrowserCorePopupFeatures
{
public:
	FBrowserCorePopupFeatures();
	FBrowserCorePopupFeatures(const CefPopupFeatures& PopupFeatures);
	virtual ~FBrowserCorePopupFeatures();

	// IBrowserCorePopupFeatures Interface
