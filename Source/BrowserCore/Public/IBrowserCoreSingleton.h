...
struct BROWSERCORE_API FBrowserContextSettings
{
...
struct BROWSERCORE_API FCreateBrowserWindowSettings
{
 ...
 */
class BROWSERCORE_API IBrowserCoreSingleton
{
public:
	/**
	 * Virtual Destructor
	 */
	virtual ~IBrowserCoreSingleton() {};

	/** @return A factory object that can be used to construct additional BrowserCoreWindows on demand. */
	virtual TSharedRef<IBrowserCoreWindowFactory> GetBrowserCoreWindowFactory() const = 0;
	 ...
	 */
	virtual TSharedPtr<IBrowserCoreWindow> CreateBrowserWindow(
		TSharedPtr<FBrowserCoreWindow>& BrowserWindowParent,
	...
	virtual TSharedPtr<IBrowserCoreWindow> CreateBrowserWindow(const FCreateBrowserWindowSettings& Settings) = 0;
	...
	virtual TSharedPtr<class IBrowserCoreCookieManager> GetCookieManager() const = 0;

	virtual TSharedPtr<class IBrowserCoreCookieManager> GetCookieManager(TOptional<FString> ContextId) const = 0;
